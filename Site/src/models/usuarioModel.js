...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT id, nome, estacao, email FROM usuario WHERE email = '${email}' AND senha = '${senha}';
    `;
...
function cadastrar(nome, email, senha, estacao) {
    ...
    var instrucaoSql = `
        INSERT INTO usuario (nome, email, senha, estacao) VALUES ('${nome}', '${email}', '${senha}', '${estacao}');
    `;
    console.log("Executando a instrução SQL: \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
